        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{BASE_URL . 'hang-hoa'}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{BASE_URL . 'hang-hoa/tao-moi'}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tạo mới</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{BASE_URL . 'danh-muc/tao-moi'}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tạo mới</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ BASE_URL . 'users/tao-moi' }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tạo mới</p>
                </a>
              </li>
