			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						...
						<form action="<?=BASE_URL. 'users/saveNew'  ?>"  method="post" class="login-form">
							...
							<div class="form-group d-flex">
								<input type="number" name="phone" class="form-control rounded-left" placeholder="số điện thoại"
									required>
							</div>
							<div class="form-group d-md-flex">
								<div class="w-50 text-md-right">
									<a href="<?= BASE_URL.'users/layoutLogin' ?>">Bạn đã có tài khoản</a>
								</div>
							</div>
							<div class="form-group">
